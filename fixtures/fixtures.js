const Fixtures = {
        ...
        1: [
            {
                ...
                market: {
                    ...
                    deleted_at: null,
                    payment_message:
                        'Thanks, your payment request has been accepted. Please mark your vouchers with the current date and return them to the office.',
            ...
            },
            {
                ...
                market: {
                    ...
                    deleted_at: null,
                    payment_message:
                        'Thanks, your payment request has been accepted. Please drop your vouchers off at the office.',
    ...
    voucherStatus: {
        ...
        error: [
            {
                error: "That isn't a valid voucher code, please check the number and try again."
            }
        ]
    },
        ...
        1: [
            {
                ...
                vouchers: [
                    {
                        code: 'RVNT12345601',
                        recorded_on: '12-02-2017',
                        reimbursed_on: '15-02-2017'
                    },
                    {
                        code: 'RVNT12345602',
                        recorded_on: '12-02-2017',
            ...
            },
            {
                ...
                vouchers: [
                    {
                        code: 'SOL10000013',
                        recorded_on: '09-03-2017',
                        reimbursed_on: '17-03-2017'
                    },
                    {
                        code: 'SOL10000017',
                        recorded_on: '09-03-2017',
        ...
        2: [
            {
                ...
                vouchers: [
                    {
                        code: 'RVNT12345678',
                        recorded_on: '08-01-2017',
                        reimbursed_on: '11-01-2017'
                    },
                    {
                        code: 'RVNT12345679',
                        recorded_on: '08-01-2017',
...
Fixtures.apply = function (mock) {
    ...
    mock.onGet('/traders/1/voucher-history').reply(
        200,
        this.traderVoucherHistory['1']
    );
    mock.onGet('/traders/2/voucher-history').reply(
        200,
        this.traderVoucherHistory['2']
    );
    mock.onPost(/\/traders\/\d\/voucher-history-email/).reply(
        202,
        "Thanks. If you don't receive an email with your voucher history, please try again later."
    );
